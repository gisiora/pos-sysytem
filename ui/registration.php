...
if($select->rowCount()>0){
  ...
  $_SESSION['status'] = "The  Email  has been taken already.";
  $_SESSION['status_code'] = "warning";
  ...
  try {
    ...
    if ($insert->execute()) {
        ...
        $_SESSION['status'] = "User registered successfully into the database";
        $_SESSION['status_code'] = "success";
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-md-8">
         <table   id="table_registeration"  class="table table-striped table-hover">
<thead>
<tr>
  <td>No</td>
  <td>Name</td>
